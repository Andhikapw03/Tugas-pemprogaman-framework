...
$beli->setName("CD music METALICA");
$beli->setPrice("150.000");
$beli->setDiscount("Diskon saat ini : <br/> 1. CDMusic = 5% <br/> 2. CDRack = 0%
(Tidak ada discount)");

echo "***PRODUCT*** <br/>"; 
echo "".$beli->getName()."<br/>";
echo "Harga :Rp.".$beli->getPrice().",-<br/>";
echo $beli->getDiscount()."<br/><hr/>";
$beli_cdm->setArtist("METALICA");
$beli_cdm->setGenre("Rock");
$beli_cdm->setDiscount("5%");
$beli_cdm->setPrice(150000);

echo "---SELAMAT DATANG DI CD MUSIC METAL--- <br/>"; 
...
$beli_cdr->setPrice(150000);



echo "---SELAMAT DATANG DI CDRACK--- <br/>"; echo "Kapasitas : " . $beli_cdr->getCapacity() . "<br/>"; echo "Model : " . $beli_cdr->getModel() . "<br/>";
